...
from user.serializers import RegisterSerializer,UserProfessionSerializer,UserFamilySerializer
from user.models import Register,UserProfile,UserLocation,UserImage,PartnerPreference,UserFamily
from versatileimagefield.serializers import VersatileImageFieldSerializer
