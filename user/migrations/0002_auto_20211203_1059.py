...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RenameField(model_name="likedprofile", old_name="user", new_name="liked_by_user"),
        migrations.RenameField(model_name="likedprofile", old_name="profile", new_name="liked_user"),
        migrations.RemoveField(model_name="partnerpreference", name="Location"),
        migrations.AddField(
