...
from user.models import LikedProfile,PassedProfile
from user.models import Register,UserProfile,UserLocation,UserImage,PartnerPreference,UserFamily,UserProfession,Message,Chat
...
class PartnerPrefenceSerializer(serializers.ModelSerializer):
    class Meta:
        model = PartnerPreference
        fields= '__all__'
        read_only_fields =('id','user','register','user_profile','user_location','user_profession','user_family','age_from','age_to','marital_status','height_from','height_to','complexion','community','highestEducation','profession','location','body_type')
