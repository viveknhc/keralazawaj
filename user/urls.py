...
urlpatterns = [
    ...
    path('user_details_complete_check/<int:pk>/',
         views.UserDetailsCompleteCheck.as_view()),
    path('check-partner-prefernce/', views.CheckPartnerPrefence.as_view(),
         name='check_partner_preference'),
    ...
    path('check_password/<str:email>/<str:pasword>/',
         views.CheckPassword.as_view()),
    path('check-user-verify/', views.CheckUserVerify.as_view()),
    path('change-password/<str:email>/<str:pasword>/',
