...
from user.forms import UserProfileForm,userLocationForm,userProfessionFrom,UserFamilyForm,PartnerPreferenceForm
...
def register(request,registerid):
    ...
    context  = {
        'register':registerid,
        'form':form,
        'user_form':userlocationform,
        'profession_form':userProfessionFrom,
        'family_form':UserFamilyForm
    }
